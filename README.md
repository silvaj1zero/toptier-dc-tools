...
Certificação da Calculadora de Virtualização **completa** (plano em `docs/research/2026-08-16-virtualizacao/00-plano.md`): curvas LBNL/DOE ✓ · validação cruzada com DC Pro ✓ · validação empírica com PUE medido de 311 instalações (EU CoC/JRC + LBNL/DOE) ✓.
